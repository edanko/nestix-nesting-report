...
namespace Report.SmartThreadPool
{
    ...
    public partial class SmartThreadPool : WorkItemsGroupBase, IDisposable
    {
        ...
        /// </summary>
        private readonly SynchronizedDictionary<Thread, ThreadEntry> _workerThreads =
            new SynchronizedDictionary<Thread, ThreadEntry>();
        ...
        /// </summary>
        private readonly SynchronizedDictionary<IWorkItemsGroup, IWorkItemsGroup> _workItemsGroups =
            new SynchronizedDictionary<IWorkItemsGroup, IWorkItemsGroup>();
        ...
        [ThreadStatic] private static ThreadEntry _threadEntry;
